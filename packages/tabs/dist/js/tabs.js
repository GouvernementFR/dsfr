...
var tabs_group_TabsGroup = /*#__PURE__*/function (_DisclosuresGroup) {
  ...
  function TabsGroup(id, element) {
    ...
    scripts["Renderer"].add(_this.render.bind(tabs_group_assertThisInitialized(_this)));
    return _this;
  }
  ...
  tabs_group_createClass(TabsGroup, [{
    ...
    value: function listen() {
      this.keyListener = new scripts["KeyListener"](this.element);
      this.keyListener.down(scripts["KeyListener"].RIGHT, this.arrowRightPress.bind(this), true, true);
      this.keyListener.down(scripts["KeyListener"].LEFT, this.arrowLeftPress.bind(this), true, true);
      this.keyListener.down(scripts["KeyListener"].HOME, this.homePress.bind(this), true, true);
      this.keyListener.down(scripts["KeyListener"].END, this.endPress.bind(this), true, true);
    }
    /**
...
var tab_Tab = /*#__PURE__*/function (_Disclosure) {
  ...
  tab_createClass(Tab, [{
    ...
    key: "type",
    get: function get() {
      return scripts["Disclosure"].TYPES.select;
    }
  }, {
    key: "selector",
    get: function get() {
...
new scripts["Initializer"]('.rf-tabs', [tabs_Tabs]);
