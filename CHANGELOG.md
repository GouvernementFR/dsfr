...
### [v1.15.1](https://github.com/GouvernementFR/dsfr/compare/v1.15.0...v1.15.1) - 20 Juillet 2026

#### ✨ feat: mise à jour de la licence [(#1483)](https://github.com/GouvernementFR/dsfr/pull/1483)
- Passage en licence etalab-2.0



### [v1.15.0](https://github.com/GouvernementFR/dsfr/compare/v1.14.4...v1.15.0) - 17 Juillet 2026

#### 📝 docs(analytics): correction terme site-segment [(#1482)](https://github.com/GouvernementFR/dsfr/pull/1482)


#### 📝 docs(modal): correction des extraits de code [(#1480)](https://github.com/GouvernementFR/dsfr/pull/1480)


#### 🐛 fix: amélioration du script preinstall & variable d'environnement [(#1476)](https://github.com/GouvernementFR/dsfr/pull/1476)
...
#### 📝 docs(modal): correction doc accessibilité de la modale [(#1479)](https://github.com/GouvernementFR/dsfr/pull/1479)


#### 🐛 fix(transcription): remplace la balise dialog par une balise div [(#1478)](https://github.com/GouvernementFR/dsfr/pull/1478)
- Remplace la balise dialog par une balise div, le rôle dialog est ajouté automatiquement à l'ouverture de la modale


#### 🐛 fix(grid): permet d'utiliser la grille sous forme de liste [(#1467)](https://github.com/GouvernementFR/dsfr/pull/1467)
...
#### 🐛 fix(transcription): corrige la démo et ajoute le titre de la modale [(#1465)](https://github.com/GouvernementFR/dsfr/pull/1465)
...
#### ✨ feat: modifie la manière d'installer le dsfr [(#1471)](https://github.com/GouvernementFR/dsfr/pull/1471)


#### 🐛 fix(skiplinks): retrait des skiplinks en version print [(#1468)](https://github.com/GouvernementFR/dsfr/pull/1468)


#### 🐛 fix: correction du script d'acceptation des cgu à l'installation [(#1463)](https://github.com/GouvernementFR/dsfr/pull/1463)


#### 🐛 fix(publiccode): corrige le format et ajout licence [(#1460)](https://github.com/GouvernementFR/dsfr/pull/1460)
