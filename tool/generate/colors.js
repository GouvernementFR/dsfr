...
const utilityColorDir = 'src/utility/colors';
const moduleVariableDir = 'module/color/variable';

const generateColors = async () => {
  const settingPath = root(`${utilityColorDir}/_setting.scss`);
  ...
  const setting = await readSassFile(settingPath);
  const settingObj = convertSassStringToJs(setting);
  const settingDecisions = settingObj.decisions;
