...
(type)_title_[id]
```
* Type : type d'action. (voir [types d'actions](custom-actions.mdx#ActionType) et [types d'actions sur les composants DSFR](component-actions.mdx)) 
...
> **Important**
> ⚠️ **Un id est obligatoire sur tous les éléments traqués** (retrouvez les éléments du dsfr nécessitant un id dans la colonne “element” du [tableau d'actions des composants du dsfr](component-actions.mdx)).
