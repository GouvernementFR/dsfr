...
titleId: Sidemenu
description: Présentation du composant Menu latéral element de navigation secondaire qui organise des liens verticaux pour guider l’usager entre différentes pages d’une même rubrique.
