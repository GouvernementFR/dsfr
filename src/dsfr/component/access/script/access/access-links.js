...
import { AccessSelector } from './access-selector.js';

class AccessLinks extends api.core.Instance {
  static get instanceClassName () {
    return 'AccessLinks';
  }

  init () {
    const access = this.queryParentSelector(AccessSelector.ACCESS);
    this.toolsLinks = access.querySelector(AccessSelector.TOOLS_LINKS);
    this.menuLinks = access.querySelector(AccessSelector.MENU_LINKS);
    ...
    switch (api.mode) {
      ...
      case api.Modes.VUE:
        this.warn(`access__tools-links content is different from access__menu-links content.
