...
description: Démonstration - Le composant Bouton permet à l’usager d’exécuter une action dans une interface numérique.
...
::dsfr-doc-storybook{storyId=button--docs}

::dsfr-doc-storybook{storyId=buttons-group--docs}
