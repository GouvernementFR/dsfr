...
Le tag peut avoir une icône juxtaposée à gauche, elle est ajoutée via la **classe utilitaire d'icône** `fr-icon--NOM-ICONE` (voir [Icônes](../../fondamentaux/icones/)), associée à une **classe de positionnement** de l'icône `fr-tag--icon-left`.
