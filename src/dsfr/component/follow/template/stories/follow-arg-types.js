...
const followArgs = {
  ...
  newsletterFormInputPlaceholder: 'Votre adresse électronique (ex. : nom@example.net)',
  newsletterFormInputLabel: 'Votre adresse électronique (ex. : nom@example.net)',
  newsletterFormInputTitle: 'Votre adresse électronique (ex. : nom@example.net)',
  newsletterFormInputhasError: false,
  newsletterFormInputError: 'Le format de l’adresse electronique saisie n’est pas valide. Le format attendu est : nom@example.net',
