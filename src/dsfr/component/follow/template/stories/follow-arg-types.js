...
const followArgs = {
  ...
  newsletterFormInputPlaceholder: 'Votre adresse électronique (ex. : nom@example.com)',
  newsletterFormInputLabel: 'Votre adresse électronique (ex. : nom@example.com)',
  newsletterFormInputTitle: 'Votre adresse électronique (ex. : nom@example.com)',
  newsletterFormInputhasError: false,
  newsletterFormInputError: 'Le format de l’adresse electronique saisie n’est pas valide. Le format attendu est : nom@example.com',
