...
export const TableSelector = {
  ...
  ROW_HEADER: `${api.internals.ns.selector('table')} ${api.internals.ns.selector('cell__row--header')}`,
  COL: `${api.internals.ns.selector('table')} thead th:not(${api.internals.ns.selector('cell__row--header')}):not(${api.internals.ns.selector('cell__actionable')})`,
