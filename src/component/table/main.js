...
api.internals.register(api.table.TableSelector.ROW_HEADER, api.table.TableRowHeader);
api.internals.register(api.table.TableSelector.ROW_SELECT, api.table.TableRowSelect);
api.internals.register(api.table.TableSelector.COL, api.table.TableCol);
