...
## Installation
### Installation locale
Le Système de Design de l’État (ci-après, le **DSFR**) est basé sur une architecture NodeJS, et utilise principalement Yarn et Npm. Afin de l'installer de manière locale, il suffit dans un premier temps de cloner ce repository.
